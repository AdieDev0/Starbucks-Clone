    ...
    <>
      ...
      <div>
        ...
        <div className="relative">
          ...
          />
          <div className="absolute top-[0px] md:top-[150px] left-5 md:left-20 lg:left-44 w-[300px] lg:w-full md:w-96 p-5">
  ...
  <div className="text-center">
    ...
    <div className="flex flex-col md:flex-row md:justify-between items-center gap-8 md:gap-10">
      ...
      <div className="text-center w-full md:w-[370px] space-y-3">
        ...
        <p className="text-black font-semibold text-lg">Create an account</p>
        <p className="text-gray-700 text-sm">
          To get started,{" "}
          <a href="/" className="underline hover:text-green-700 transition">
            join now.
          </a>{" "}
          You can also{" "}
          <a href="/" className="underline hover:text-green-700 transition">
      ...
      <div className="text-center w-full md:w-[370px] space-y-3">
        ...
        <p className="text-black font-semibold text-lg">Order and pay your way</p>
        <p className="text-gray-700 text-sm">
          Use cash, credit, debit, or pay through the app. You'll earn Stars all ways.{" "}
          <a href="/" className="underline hover:text-green-700 transition">
            Learn how.
          </a>
        </p>
      ...
      <div className="text-center w-full md:w-[370px] space-y-3">
        ...
        <p className="text-black font-semibold text-lg">Collect Stars, earn Rewards</p>
        <p className="text-gray-700 text-sm">
          When you collect Stars, you can redeem them for Rewards — like free food and drinks.
        </p>
      </div>
    </div>
  </div>
...
<div className="bg-[#F2F0EB] py-10 px-4 md:px-10 lg:px-20 ">
  <div className="text-center grid gap-5">
    ...
    <p className="text-black text-sm md:text-xl">
      No matter how you pay, you can collect Stars. Those Stars add up to (really delicious) Rewards.
    </p>
